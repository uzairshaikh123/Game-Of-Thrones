    ...
    return (
        <>
            <div>
                ...
                <div className="absolute text-5xl text-rose-950 font-bold top-40 inset-x-1/3 font-mono backdrop-blur-sm px-2.5 py-2.5">
                    <h1 className="drop-shadow-[0_200px_100px_100px_rgba(80,4,21,255)]">Battle For Throne</h1>
                    {/* <h1>Raja Mantri</h1> */}
                </div>
